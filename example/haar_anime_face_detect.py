...
def haar_anime_face_detect(image_path, model_path):
    ...
    # cv2.imwrite(f'../result/haar_anime_face_detect_{image_path[-5]}.jpg', img)  # 保存检测结果
    return img


if __name__ == '__main__':
    haar_anime_face_detect(sys.argv[1], '../model/haar_anime_face_detect.xml')
